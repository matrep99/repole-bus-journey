export default function OrariPrezzi() {
  return (
    <div className="px-4 py-8 max-w-6xl mx-auto">
      <nav aria-label="breadcrumb" className="mb-3">
        <a href="#/" className="text-[#0D4FA8] font-semibold hover:underline">← Torna alla Home</a>
      </nav>

      <h1 className="text-3xl font-extrabold text-[#0D4FA8]">Orari e Prezzi</h1>
      <p className="text-slate-600 mt-1">Orari ufficiali — validi salvo variazioni straordinarie.</p>
      ...
      <section className="mt-6">
        <h2 className="text-2xl font-bold text-[#0D4FA8]">Linea 287 — Rapone ↔ Ruvo del Monte (SS 401)</h2>
      ...
      <section className="mt-8">
        <h2 className="text-2xl font-bold text-[#0D4FA8]">Linea 286 — Rapone ↔ Calitri</h2>
        ...
        <table className="timetable">
          ...
          <tbody>
            ...
            <tr><td className="sticky">Area di interscambio – Area industriale Rapone</td>
                                                                             <td>06:45</td><td>07:05</td><td>07:40</td><td>13:25</td><td>—</td><td>18:35</td></tr>
      ...
      {/* ===== PREZZI (riempi le cifre reali) ===== */}
      <section className="mt-10">
        <h2 className="text-2xl font-bold text-[#0D4FA8]">Prezzi biglietti</h2>
        <table className="timetable price-table">
          <caption>Tariffe — singola corsa e A/R</caption>
          <thead>
            <tr>
          ...
          <tbody>
            {/* Sostituisci € — con i prezzi ufficiali */}
